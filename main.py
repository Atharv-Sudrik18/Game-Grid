...
def contact():
    if request.method == "POST":
        ...
        msg = Message(
            ...
            sender="gamegrid123@gmail.com",
            recipients=["gamegrid123@gmail.com"]
        )
...
"""
        ...
        try:
            ...
            print("Email error:", e)
            return "Message saved, but email could not be sent."
...
def reset_password():
    ...
    return render_template("reset_password.html")        cursor.close()
        conn.close()
        return "Message sent successfully!"
    return render_template("contact.html")
